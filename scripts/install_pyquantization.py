#!/usr/bin/env python3
"""Download and install pyquantization from GitHub releases.

Automatically detects platform and Python version to download the correct wheel.

Usage:
    python scripts/install_pyquantization.py [--version v0.1.0]
"""
...
REPO = "mfagerlund/pyquantization"
...
def main():
    parser = argparse.ArgumentParser(description="Install pyquantization from GitHub releases")
    parser.add_argument("--version", "-v", help="Specific version tag (e.g., v0.1.0)")
    ...
    try:
        ...
        print("  git clone https://github.com/mfagerlund/pyquantization.git")
        print("  cd pyquantization && pip install .")
        sys.exit(1)
    ...
    if not url:
        ...
        print("  pip install git+https://github.com/mfagerlund/pyquantization.git")
        sys.exit(1)
